...
def test_model(test_motif,test_motif_mask,test_seq,test_mask, model_name, model_path):
    ...
    model = tf.keras.models.load_model(model_name + 'PhosPPI-SEQ_Y_effect.h5',compile=False,custom_objects={'TFRobertaModel':TFRobertaModel})
...
if __name__ == "__main__":
    ...
    model_name = "PhosPPI-SEQ_Y_effect"
    model_path = f'./'

    test_file = f'test_data_Y_effect.xlsx'
